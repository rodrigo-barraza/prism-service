...
let fetchHuggingFaceMetadata: typeof import('../hfMetadata.ts').fetchHuggingFaceMetadata;
let enrichWithHuggingFace: typeof import('../hfMetadata.ts').enrichWithHuggingFace;
