...
import { SYSTEM_STATUSES } from "../src/constants.ts";

import { SERVER_SENT_EVENT_TYPES } from "@rodrigo-barraza/utilities-library/taxonomy";
import ConversationGenerationTracker from "../src/services/ConversationGenerationTracker.ts";
import ConversationStatusRegistry from "../src/services/ConversationStatusRegistry.ts";

vi.mock("../src/services/conversation/ConversationService.ts");
vi.mock("../src/services/ConversationStatusRegistry.ts", () => ({
  default: {
    set: vi.fn(),
    patch: vi.fn(),
  },
