...
let getInstance: typeof import('../src/providers/instance-registry.ts').getInstance;
let isInstance: typeof import('../src/providers/instance-registry.ts').isInstance;
let listInstances: typeof import('../src/providers/instance-registry.ts').listInstances;
let listInstanceTypes: typeof import('../src/providers/instance-registry.ts').listInstanceTypes;
let getInstancesByType: typeof import('../src/providers/instance-registry.ts').getInstancesByType;
let getInstanceType: typeof import('../src/providers/instance-registry.ts').getInstanceType;
let getInstanceProvider: typeof import('../src/providers/instance-registry.ts').getInstanceProvider;

beforeEach(async () => {
  const module = await import('../src/providers/instance-registry.ts');
